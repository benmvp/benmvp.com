...
<Image src="circle.svg" alt="SVG circle" style={{ display: 'block', margin: '0 auto 16px' }}  />
...
<Image src="circle-linear-gradient.svg" alt="SVG circle with linear gradient" style={{ display: 'block', margin: '0 auto 16px' }}  />
...
<Image src="circle-linear-gradient-rotate.svg" alt="Rotating SVG circle with linear gradient" style={{ display: 'block', margin: '0 auto 16px' }}  />
...
<Image src="circle-radial-gradient.svg" alt="SVG circle with radial gradient" style={{ display: 'block', margin: '0 auto 16px' }}  />
...
<Image src="circle-radial-gradient-fill.svg" alt="SVG circle with radial gradient fill" style={{ display: 'block', margin: '0 auto 16px' }}  />
...
<Image src="circle-arc-paths.svg" alt="SVG circle sliced into 20 paths segments" style={{ display: 'block', margin: '0 auto 16px' }}  />
...
<Image src="circle-arc-paths-rotate.svg" alt="Rotating SVG circle sliced into 20 paths segments" style={{ display: 'block', margin: '0 auto 16px' }}  />
...
<Image src="codepen-animated-spinner.svg" alt="Animated spinner example from Codepen" style={{ display: 'block', margin: '0 auto 16px' }}  />
...
<Image src="semicircles-linear-gradient.svg" alt="Two SVG semicircles with separate linear gradients" style={{ display: 'block', margin: '0 auto 16px' }}  />
...
<Image src="semicircles-linear-gradient-rotate.svg" alt="Two rotating SVG semicircles with separate linear gradients" style={{ display: 'block', margin: '0 auto 16px' }}  />
