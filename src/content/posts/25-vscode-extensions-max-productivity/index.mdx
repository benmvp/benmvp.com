...
<Image src="git-lens.png" alt="Screenshot of the GitLens VS Code extension" />
...
<Image src="vscode-jest.gif" alt="Animated screenshot of the Jest VS Code extension" />
...
<Image src="auto-rename-tag.gif" alt="Animated screenshot of the Auto Rename Tag VS Code extension" />
...
<Image src="npm-intellisense.gif" alt="Animated screenshot of the npm intellisense VS Code extension" />
...
<Image src="search-node_modules.gif" alt="Animated screenshot of the Search node_modules VS Code extension" />
...
<Image src="view-node-package.png" alt="Screenshot of the View Node Package VS Code extension" />
...
<Image src="quit-control.gif" alt="Animated screenshot of the Quit Control VS Code extension" />
