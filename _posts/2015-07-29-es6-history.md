...
ECMAScript 6 is the new version of JavaScript making its way into the interpreters of our modern browsers and servers. I’m embarking on the _[Learning ES6](http://www.benmvp.com/2015/08/the-learning-es6-series.html)_ series to walk through the various features of ES6. We’ll take a look at [arrow functions](http://www.benmvp.com/2015/08/learning-es6-arrow-functions.html), modules, rest parameters and a host of other goodies that the ES6 specification brings to the JavaScript that we write on a daily basis.
...
For the remainder of [this series](http://www.benmvp.com/2015/08/the-learning-es6-series.html), we’ll zero in on ECMAScript 6 (ECMAScript 2015 to be absolutely correct), starting with an [overview of its goals and features](http://www.benmvp.com/2015/08/learning-es6-goals-features-of-ecmascript-6.html) coming up next.
