...
If you haven’t already, you should read the previous posts in this [_Learning ES6_ series](http://www.benmvp.com/2015/08/the-learning-es6-series.html) where we’ve learned about the [history of ECMAScript](http://www.benmvp.com/2015/07/learning-es6-history-of-ecmascript.html) as well as the [goals and features of ES6](http://www.benmvp.com/2015/08/learning-es6-goals-features-of-ecmascript-6.html).
...
- None of the Internet Explorer browsers (from 11 on down) significantly support any ES6 features (and never plan to either). [IE8 and below don’t even support ES5!](http://www.benmvp.com/2015/08/20-reasons-to-drop-ie8-like-its-hot.html)
...
- IE8 does not support ES5. [You shouldn't be supporting IE8](http://www.benmvp.com/2015/08/20-reasons-to-drop-ie8-like-its-hot.html), but if you are, your transpiled ES5 code may not work
...
- **If you’re part of a team, how familiar is the rest of the team with ES6?** Introducing ES6 features and the transpilation build process to a team unfamiliar with ES6 could lead to confusion and could be a recipe for disaster. Have them go through this [_Learning ES6_](http://www.benmvp.com/search/label/learning%20es6) series first!
