...
Much easier, huh? Much more readable too. The example also leverages [rest parameters](/learning-es6-parameter-handling/#rest-parameters). I like to think of it as analogous to [`Array.prototype.every`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/every), which returns `true` (success) if all of the elements of the array pass the test implemented in the callback.
